...
class OperationMinTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDoOperation()
    {
        ...
        $this->specify('testes passando valores não numéricos, deve descartar', function () {
            verify($this->operation->doOperation(1, null))->equals(1);
            verify($this->operation->doOperation(1, 0))->equals(0);
            verify($this->operation->doOperation(null, 1))->equals(1);
            verify($this->operation->doOperation('texto', 'texto'))->null();
